        ...
        <main class="col-span-3 mr-14">
            ...
            <section class="grid grid-cols-4 gap-3 mt-5">
                @foreach ($products as $product)
                    <a class="pb-1 bg-white hover:bg-gray-50 overflow-hidden flex flex-col gap-3 rounded-lg"
                        href="{{ route('product.show', $product['id']) }}">
                        <div class="relative">
                            {{-- <img class="bg-gray-200 w-full h-[250px] object-cover"
                                src="{{ asset('img/upload/' . $product['gambar']) }}" alt=""> --}}
                            <div class="w-full h-[250px] bg-gray-300 rounded-lg flex items-center justify-center">
                                🪑
                            </div>
                        </div>
                        <div class="flex flex-col justify-between gap-2 h-full px-4 pb-2">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <p>{{ $product['rating'] }} | {{ $product['review'] }} reviews</p>
                            </div>
                        </div>
                    </a>
                @endforeach
